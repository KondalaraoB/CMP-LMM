...
%%-------------------------------------------------------------------------
  ...
  for N=1:N_a
     ...
     D_x_G_eia=D_x_G_ei(NN_a);
     D_y_G_eia=D_y_G_ei(NN_a);
     D_z_G_eia=D_z_G_ei(NN_a);
     
     DD_x_G_eia=DD_x_G_ei(NN_a);
     DD_y_G_eia=DD_y_G_ei(NN_a);
     DD_z_G_eia=DD_z_G_ei(NN_a);
...
for N=1:NN1
    r_G_pi3_oa1=[x_G_ei(1,N) y_G_ei(1,N) z_G_ei(1,N)];
